...
-- Diagnostic keymaps
-- TODO: Is this the same as the quickfix list that works with cclose and copen and cnext and cprev
...
require('lazy').setup({
  ...
  -- personal add plugins
  -- {
  --   'codota/tabnine-nvim',
  --   opts = { build = './dl_binaries.sh' },
  --   config = function()
  ...
  },
  {
    ...
    config = function()
      ...
      end, { silent = true, desc = 'jump to context declaration(upward)' })
    end,
  },
